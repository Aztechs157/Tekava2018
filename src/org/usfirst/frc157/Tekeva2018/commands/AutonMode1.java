...
import org.usfirst.frc157.Tekeva2018.commands.AutonMode0.autonState;
...
public class AutonMode1 extends Command {
	...
	public enum autonState {
		driveArc1, wait1000Msec1, driveArc2, wait1000Msec2, turnRight90, wait1000Msec3, driveArc3;
	}
	...
	public AutonMode1() {
		...
		/*
		 * try { pathManager = new PathManager(); pathOpen = true; } catch(Exception e)
	...
	protected void execute() {
		/*
		 * if (pathOpen) {
		 * pathManager.update(-(Robot.drive.getRightEncoder()+Robot.drive.getLeftEncoder
		 * ())/2.0, Robot.drive.getAngle()); }
		 */
		switch (state) {
