...
public class RobotMap {
    ...
    public static AnalogPotentiometer forkliftforkAnalogPotentiometer;
    ...
    public static void init() {
        ...
        driveRightQuad = new Encoder(3, 4, true, EncodingType.k4X);
        ...
        forkliftforkAnalogPotentiometer = new AnalogPotentiometer(2, 127.0, 0.0); // (Pin, Scale, Offset)
